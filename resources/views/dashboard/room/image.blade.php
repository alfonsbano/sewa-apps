...
@section('title')
<title>Dashboard | Tambah Foto Aula</title>
@endsection
@section('content')
<div class="row">
    <div class="col-lg-12">
        <div class="container">
            <div class="card border-0 shadow">
                <div class="card-header">
                    <h4>Tambah foto Aula {{ $room->no }} #{{ $room->id }}</h4>
                </div>
                        ...
                        <div class="col-lg-5 col-12 order-1 order-md-2 col-md-5">
                            <div class="row">
                                ...
                                <div class="col-md-9 col-lg-9">
                                    <label for="image" class="form-label">Tambah Foto Aula </label>
